...
// A/D MULTIPLEXER SELECTION REGISTER
...
// SFIOR Register
#define SFIOR_ADDRESS	0x50

#define ADCSRA (* (volatile uint8 *) ADCSRA_ADDRESS)
#define ADMUX (* (volatile uint8 *) ADMUX_ADDRESS)
#define ADCH (* (volatile uint8 *) ADCH_ADDRESS)
#define ADCL (* (volatile uint8 *) ADCL_ADDRESS)
#define SFIOR (* (volatile uint8 *) SFIOR_ADDRESS)
